  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        d: common_vendor.t(common_vendor.unref(detail).skin),
        e: common_vendor.t(common_vendor.unref(detail).level),
        f: common_vendor.t(common_vendor.unref(detail).legend ? common_vendor.unref(detail).legend : "\u65E0"),
        g: common_vendor.t(common_vendor.unref(detail).national ? common_vendor.unref(detail).national : "\u65E0")
      } : {});
    };
  }
});
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-7506fc04"], ["__file", "C:/Users/yzc/Desktop/game-trade/src/components/Options/GloryOfTheKing/index.vue"]]);
